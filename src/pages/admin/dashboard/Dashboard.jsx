                ...
                <div
                    ...
                    <div className="left">
                        <img
                            ...
                            src={'https://t4.ftcdn.net/jpg/06/59/13/31/360_F_659133125_S0VAnb5NNknokdB47K61zDsczWgZJTMf.jpg'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">jashan08sandhu@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                            <span> </span>  
                        ...
                        <div className="relative overflow-x-auto shadow-md sm:rounded-xl">
                            ...
                            <table className="w-full border-2 border-white shadow-md text-sm text-left text-gray-500 dark:text-gray-400" >
                                ...
                                <thead
                                    ...
                                    className="text-xs ">
                                    <tr>
                                        <th style={{ color: mode === 'dark' ? 'rgb(30, 41, 59)' : 'black' }} scope="col" className="px-6 py-3">
                                            S.No
                                        </th>
                                        <th style={{ color: mode === 'dark' ? 'rgb(30, 41, 59)' : 'black' }} scope="col" className="px-6 py-3">
                                            Thumbnail
