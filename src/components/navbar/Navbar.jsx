                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            ...
                            <img
                                className=' w-10 h-10 '
                                src='https://static.vecteezy.com/system/resources/thumbnails/006/607/545/small/stone-logo-template-in-white-background-free-vector.jpg'
                            />
                            {/* Logo Text  */}
                            <span>
                                Stone
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* <div>
                            {mode === 'light'
                                ...
                                <>
                                    {}
                                    <IconButton onClick={toggleMode} className=" lg:inline-block rounded-full" style={{ background: mode === 'light' ? '#ced6e0' : '#57606f', color: mode === 'dark' ? 'black' : 'black' }}>
                        ...
                        <div>
                            <IconButton
                                ...
                                style={{ background: mode === 'light' ? '#ced6e0' : '#57606f', color: mode === 'dark' ? 'black' : 'black' }}
                            >
                                {openNav ?
                                    (
                                        <svg
